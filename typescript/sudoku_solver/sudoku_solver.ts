...
function solveSudokuBits(rows: number[], cols: number[], blocks: number[], bitBoard: number[][], queues: { q: object, r: object, c: object, b: object }): number[][] {
    let intersect = 0;
...
function convertToBits(board: string[][]): [number[][], number[][], { q: object, r: object, c: object, b: object }] {
...
function convertToStrings(board: string[][], bitBoard: number[][]): string[][] {
    for (let r = 0; r < 9; r++) {
        for (let c = 0; c < 9; c++) {
